...
def matching_workflow_endpoint():
    ...
    try:
        ...
        # Call the matching workflow (it handles normalization internally)
        print(f"🔄 Starting matching workflow...")
        result = matchingworkflow.main(data)
        ...
        if result.get("success"):
            ...
            if "validation" in error_msg.lower() or "invalid" in error_msg.lower() or "Missing required field" in error_msg:
                status_code = 422
            else:
                status_code = 500
